...
using Hurrah.GoogleDrive.Sessions;
using Hurrah.GoogleDrive.Web.Controllers.Results;
using Hurrah.GoogleDrive.Web.Models;
using Hurrah.GoogleDrive.Web.Models.Account;
...
{
    public class AccountController : GoogleDriveControllerBase
    {

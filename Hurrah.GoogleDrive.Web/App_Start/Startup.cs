...
﻿using Abp.Owin;
using Hurrah.GoogleDrive.Api.Controllers;
using Hurrah.GoogleDrive.Web;
...
namespace Hurrah.GoogleDrive.Web
{
    public class Startup
    {
        public void Configuration(IAppBuilder app)
        {
            ...
            //ENABLE TO USE HANGFIRE dashboard (Requires enabling Hangfire in GoogleDriveWebModule)
